# wat-http-serve — minimal HTTP handler interface (Rack analog)
...
Naming locked: `wat-http-serve` (this arc) + `wat-http-route`
...
```
LAYER 4 — wat-http-route   DSL on top (arc 010)
LAYER 3 — wat-http-serve   Minimal handler interface (THIS ARC)
