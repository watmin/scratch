...
| `wat-to-english.md` | The inverse direction. The user's premise: *"i was equally convinced we can translate wat-english forms to english... i don't think i actually wrote it... conceptually... thought."* The conviction held; OG wat never shipped it. **Updated 2026-05-02 after a mid-conversation collapse:** the user pointed at the realization I'd demoted to Layer 3 — *"the to-string is an llm call.. 'render this edn-form as english'... they have the familiar engrams already."* That collapses the entire renderer design. The wat-english crate ships ZERO rendering code; rendering is one MCP call. Protocol shape count corrected from five back to four (Express / Reflect / Verify / Recall) — Render is a surface choice on Reflect, not a fifth shape. Round-trip lossiness still applies (TCP property). |
